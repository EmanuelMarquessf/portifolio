...
<template>
  <div class="flex flex-col gap-6">
    ...
    >
      <div class="flex flex-col md:flex-row gap-4 w-full">
        <input
          v-model="form.name"
          class="flex-1 p-4 bg-cardColor rounded grow border-0 focus:border-none focus:outline-none focus:ring-0 focus:shadow-none"
          type="text"
      ...
      <textarea
        ...
        class="flex-1 w-full p-4 bg-cardColor rounded grow border-0 focus:border-none focus:outline-none focus:ring-0 focus:shadow-none resize-none"
  ...
  :class="[
    ...
    !(form.name && form.email && form.message) ? 'disabled opacity-60 cursor-context-menu' : ''
  ]"
>
