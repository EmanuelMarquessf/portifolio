...
<template>
  <div
    class=" w-full md:w-[672px] lg:w-[456px] xl:w-[362px] xl:flex-1 xl:basis-1/5 flex flex-col justify-between p-4 bg-[#31313f] rounded shadow xl:grow gap-2 opacity-70 hover:scale-105 hover:opacity-100 transition-all duration-500 ease-in-out"
  >
    ...
    <p
      class="text-white text-[1.125rem] font-poppins font-medium md:w-[20rem] xl:w-[20.5rem] md:h-[4.rem]"
    >
    ...
    <div class="flex flex-row gap-4 mt-4">
      <a
        ...
        target="_blank"
        class="bg-primaryColor py-[12px] rounded-lg flex items-center grow justify-center hover:bg-white transition-colors duration-500 hover:text-primaryColor text-white font-poppins font-semibold text-[1rem]"
      >
      ...
      <a
        ...
        target="_blank"
        class="bg-transparent hover:bg-secondaryColor py-[12px] rounded-lg border-solid border-2 border-primaryColor text-white flex items-center grow justify-center transition-colors duration-500"
      >
        <span class="text-white font-poppins font-semibold text-[1rem]"
          >GitHub Repo</span
        >
      ...
      <a
        ...
        target="_blank"
        class="bg-transparent py-[12px] rounded-lg border-solid border-2 border-primaryColor text-white flex items-center grow justify-center pointer-events-none opacity-40"
      >
        <span class="text-white font-poppins font-semibold text-[1rem]"
          >GitHub Repo</span
        >
