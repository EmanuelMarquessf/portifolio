    ...
    >
      <div class="flex flex-col lg:gap-10">
        <div class="flex flex-col">
          ...
          <div class="flex flex-col gap-8">
            ...
            >
              Olá, eu sou Emanuel Marques, tenho 23 anos e sou graduado em
              Análise e Desenvolvimento de Sistemas pelo IFSP Campus Campos do
              Jordão. No momento, estou dedicando meu tempo aos estudos na área
              de desenvolvimento web, com um foco específico no front-end. Estou
              focado em encontrar minha primeira oportunidade como programador.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div class="md:flex md:flex-col hidden lg:hidden">
          ...
          <span
            class="text-white font-poppins font-medium md:text-[1.1rem]"
          >
            Desenvolvedor Front-end & Designer Ui/Ux
          </span>
        </div>
