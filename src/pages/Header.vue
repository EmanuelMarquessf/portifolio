<template>
  <header class="bg-darkColor h-20 w-full flex justify-between px-[8rem] content-center items-center fixed z-20">
    ...
    <span class="buttonsMenu flex justify-between  gap-16">
      ...
      <a href="#experience" class="text-white font-poppins font-semibold text-md">Experience</a>
      <a href="#tecno" class="text-white font-poppins font-semibold text-md">Tecnologie</a>
      <a href="#projects" class="text-white font-poppins font-semibold text-md">Projects</a>
      <a href="#contact" class="text-white font-poppins font-semibold text-md"> Contact</a>
    </span>
  </header>
</template>